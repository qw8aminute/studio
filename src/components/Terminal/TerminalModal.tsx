...
export default function TerminalModal({ 
  ...
  return (
  <div className="terminal-canvas" role="dialog" aria-modal="true">
    <div
    ...
    <animated.div
      ...
      // prevent backdrop close when tapping inside window
      onClick={(e) => e.stopPropagation()}
    >
      {contentTransition((style, item) =>
        item ? (
          <animated.div className="terminal-content" style={style}>
            <div className="terminal-header">
              <div className="terminal-controls">
                <button className="terminal-btn close" onClick={onClose} title="Close" />
                <button className="terminal-btn minimize" onClick={onMinimize} title="Minimize to dock" />
                <button className="terminal-btn maximize" onClick={handleMaximize} title={isMaximized ? 'Restore' : 'Maximize'} />
              </div>
