...
export default function ForceGraph({ onNodeSelect }) {
    ...
    useEffect(() => {
        ...
        const initNodes = () => {
            ...
            text.split('').forEach((char, i) => {
                ...
                const targetX = padding + (width - padding * 2 - adjustedTotalWidth) / 2 + i * adjustedSpacing;
    ...
    return _jsx("canvas", { ref: canvasRef, className: "force-graph" });
}
